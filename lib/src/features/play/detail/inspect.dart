...
class PlayInspectView extends StatefulWidget {
  const PlayInspectView({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _PlayInspectViewState();
}

class _PlayInspectViewState extends State<PlayInspectView> {
